...
|---|-----------|------------------|---------------------|-------------------------------|--------|------------|
| 1 | RDP Brute Force | Hydra failed RDP logons | Windows Security | 4625 | Planned | Pending |
...
| 10 | Defender Tampering | Defender tampering command simulation | Sysmon | Event ID 1 | Planned | Pending |
| 11 | Scheduled Task Created | schtasks test | Windows/Sysmon | 4698 / Event ID 1 | Planned | Pending |
| 12 | New Service Installed | sc.exe create test service | System/Sysmon | 7045 / Event ID 1 | Planned | Pending |
